...
const createSong = `mutation createSong ($albumId: ID!) {
  createSong {
    title
    songId
  }
...
export { createAlbum, deleteAlbum, updateAlbum, createUser, createUserAndArtist, updateUser, createArtist, createSong }
